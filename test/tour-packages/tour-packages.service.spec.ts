...
describe('TourPackagesService', () => {
    ...
    describe('deactivate', () => {
        it('should throw ConflictException if already inactive', async () => {
            prismaMock.tourPackage.findUnique.mockResolvedValue({ ...mockTourPackage, active: false });
    ...
    describe('activate', () => {
        it('should throw ConflictException if already active', async () => {
            prismaMock.tourPackage.findUnique.mockResolvedValue({ ...mockTourPackage, active: true });
    ...
    describe('remove', () => {
        ...
        it('should delete successfully if no active reservations', async () => {
            ...
            expect(prismaMock.tourPackage.delete).toHaveBeenCalledWith({ where: { id: 1 } });
        });
    });
});
