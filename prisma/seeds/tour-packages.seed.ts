...
export async function seedTourPackages(prisma: PrismaClient) {
    ...
    if (suppliers.length === 0 || districts.length === 0 || categories.length === 0 || educationLevels.length === 0) {
        throw new Error('Missing dependencies for tour packages seed. Seed suppliers, districts, categories and education levels first.');
    }

    const tourPackagesData = [
        {
            name: 'Aventura en Machu Picchu',
            description: 'Un viaje inolvidable a la ciudadela inca con guía especializado.',
            pricePersona: 450.00,
        ...
        },
        {
            ...
            description: 'Avistamiento de cóndores y baños termales en el corazón de Arequipa.',
            pricePersona: 280.00,
        ...
        },
        {
            ...
            description: 'Navegación por el Amazonas y encuentro con comunidades locales.',
            pricePersona: 520.00,
        ...
        },
        {
            ...
            description: 'Visita a las islas flotantes de los Uros y la isla de Taquile.',
            pricePersona: 310.00,
        ...
        },
        {
            ...
            description: 'Reto físico en el Parque Nacional Huascarán con vistas glaciares.',
            pricePersona: 150.00,
        ...
        },
        {
            ...
            description: 'Viaje en teleférico hacia la impresionante fortaleza Chachapoyas.',
            pricePersona: 380.00,
